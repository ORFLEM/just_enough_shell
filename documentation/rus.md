...
<div align="left">
  ...
  <br>
	...
	В данном репозитории есть референсные настройки, которые потребляют ~5-10% на цп при одномомниторном стеке и ~7-13% на многомониторном стеке.<br>
  <br>
  ...
  <b>[c]</b> Разработка api для работы с plugin center<br>
	...
	<b>[i]</b> Новый метод подключения кастом wm<br>
